...
export const resourceLinks = [
  ...
  {
    label: 'Dashboard',
    href: 'https://sa.themesh.au/',
    summary: 'Live South Australian MeshCore dashboard and node visibility.'
  },
  {
    label: 'Map',
  ...
  },
  {
    ...
    href: 'https://themesh.au/',
    summary: 'Australia-wide MeshCore community directory.'
  }
];
